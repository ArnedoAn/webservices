...
$client = new nusoap_client('http://localhost/webservices/samples/serverAgo21.php?wsdl','wsdl');//se crea el objeto cliente y le paso como parametros la 'url?wsdl','wsdl'
 ...
 *********************/
$param = array('numero1' => 10,'numero2' => 0);//parametros de lo que defino en la funcion del metodo de generic_server.php
