...
$client = new nusoap_client('http://localhost/webservices/samples/Agosto28/serverAgo28.php?wsdl','wsdl');//se crea el objeto cliente y le paso como parametros la 'url?wsdl','wsdl'
 ...
 *********************/
$param = array('cadena' => 'WTF');//parametros de lo que defino en la funcion del metodo de generic_server.php
