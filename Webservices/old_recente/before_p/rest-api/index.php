...
$client = new nusoap_client('http://localhost/WebServices/WebCamUTS/uts_server.php?wsdl', 'wsdl');
$err = $client->getError();
if ($err) {
                ...
                <form name="fromConsultar" method="POST">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($resulDeco as $registro) {
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        &apellido=<?php echo $registro[3] ?>
                                        &fechaNacimiento=<?php echo $registro[4] ?>
                                        &genero=<?php echo $registro[5] ?>
                                        &escolaridad=<?php echo $registro[6] ?>
                                        &estadoCivil=<?php echo $registro[7] ?>">
                            ...
                            ?>
                            <tr>
                                <td colspan="9" align="center"><a href="crearEmpleado.html"><input type="button"
